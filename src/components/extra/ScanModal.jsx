...
const ScanModal = () => {
    ...
    return isPopupShown && (
        <section onClick={() => setIsPopupShown(false)} className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50'>
            <div className='w-[600px] rounded-[36px] bg-[#fffbff] flex justify-center py-4'>
                {/* WHOLE BODY */}
                <div className='flex flex-col items-center gap-y-2'>
                    ...
                    <div className='w-[350px] mt-8'>
                        <h1 className='font-semibold text-3xl text-[#2e2e2e] mb-2 text-center'>Scan to download</h1>
